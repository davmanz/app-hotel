...
-- Tiempo de generación: 22-04-2024 a las 06:38:29
...
INSERT INTO `admins` (`id`, `nickname`, `name`, `last_name`, `email`, `password_hash`, `activate`) VALUES
('9e87r66aw3eaef2', 'saske', 'David Jose', 'Manzano Arias', '', '$2b$10$K6AO.sJpMvxIIcbwfiPciOBLENnjJzrii8tTT0/klDn7w9RIO6WZ.', 1);
...
CREATE TABLE `payment_history` (
  ...
  `paid_image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `phone`, `password_hash`, `personal_photo`, `document_number`, `document_id`, `r_person_a`, `r_person_a_phone`, `r_person_b`, `r_person_b_phone`, `active`) VALUES
('54654fe65d65fd4', 'David Jose', 'Manzano Arias', 'davidjosemanzano@gmail.com', 914968452, '$2b$10$K6AO.sJpMvxIIcbwfiPciOBLENnjJzrii8tTT0/klDn7w9RIO6WZ.', NULL, '005716530', 2, 'Carlos Martines', 854745965, 'Daniel Contreras', 351254751, 1),
('d1518e7d-d22d-4ee4-affd-88598404c43f', 'David Jose', 'Manzano Arias', 'davidjosemanzano@gmail.com', 963414460, '$2b$10$.pPTtlG4Xn0wdTmJpJGem.e0qsPGFJxRwlV89zClrPrtdD346AJZC', '../uploads/users/userDefault.png', '005716530', 1, 'Carlos Medina', 963258741, 'Sergio Aurora', 987456321, 1);
